...
const file_proto_api_v1_api_proto_rawDesc = "" +
	"\n" +
	"\x16proto/api/v1/api.proto\x12\tpublickey\"\a\n" +
	"\x05Empty\"2\n" +
	"\x11PublicKeyResponse\x12\x1d\n" +
	"\n" +
	"public_key\x18\x01 \x01(\tR\tpublicKey2R\n" +
	"\x10PublicKeyService\x12>\n" +
	"\fGetPublicKey\x12\x10.publickey.Empty\x1a\x1c.publickey.PublicKeyResponseB\x1eZ\x1cauthn-server/proto;publickeyb\x06proto3"
