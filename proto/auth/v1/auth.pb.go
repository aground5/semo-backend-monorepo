...
const file_proto_auth_v1_auth_proto_rawDesc = "" +
	"\n" +
	"\x18proto/auth/v1/auth.proto\x12\fsemo.auth.v1\"@\n" +
	...
	"\x04user\x18\x03 \x01(\v2\x16.semo.auth.v1.UserInfoR\x04user\"W\n" +
	...
	"\x04user\x18\x02 \x01(\v2\x16.semo.auth.v1.UserInfoR\x04user\"5\n" +
	...
	"\x04role\x18\x04 \x01(\tR\x04role2\xb5\x02\n" +
	"\vAuthService\x12B\n" +
...
var file_proto_auth_v1_auth_proto_goTypes = []any{
	(*LoginRequest)(nil),     // 0: semo.auth.v1.LoginRequest
	(*LoginResponse)(nil),    // 1: semo.auth.v1.LoginResponse
	(*RegisterRequest)(nil),  // 2: semo.auth.v1.RegisterRequest
	(*RegisterResponse)(nil), // 3: semo.auth.v1.RegisterResponse
	(*ValidateRequest)(nil),  // 4: semo.auth.v1.ValidateRequest
	(*ValidateResponse)(nil), // 5: semo.auth.v1.ValidateResponse
	(*RefreshRequest)(nil),   // 6: semo.auth.v1.RefreshRequest
	(*RefreshResponse)(nil),  // 7: semo.auth.v1.RefreshResponse
	(*UserInfo)(nil),         // 8: semo.auth.v1.UserInfo
}
var file_proto_auth_v1_auth_proto_depIdxs = []int32{
	8, // 0: semo.auth.v1.LoginResponse.user:type_name -> semo.auth.v1.UserInfo
	8, // 1: semo.auth.v1.ValidateResponse.user:type_name -> semo.auth.v1.UserInfo
	0, // 2: semo.auth.v1.AuthService.Login:input_type -> semo.auth.v1.LoginRequest
	2, // 3: semo.auth.v1.AuthService.Register:input_type -> semo.auth.v1.RegisterRequest
	4, // 4: semo.auth.v1.AuthService.Validate:input_type -> semo.auth.v1.ValidateRequest
	6, // 5: semo.auth.v1.AuthService.Refresh:input_type -> semo.auth.v1.RefreshRequest
	1, // 6: semo.auth.v1.AuthService.Login:output_type -> semo.auth.v1.LoginResponse
	3, // 7: semo.auth.v1.AuthService.Register:output_type -> semo.auth.v1.RegisterResponse
	5, // 8: semo.auth.v1.AuthService.Validate:output_type -> semo.auth.v1.ValidateResponse
	7, // 9: semo.auth.v1.AuthService.Refresh:output_type -> semo.auth.v1.RefreshResponse
