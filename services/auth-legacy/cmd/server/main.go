...
import (
	...
	grpcEngine "authn-server/internal/app/grpc"
	httpEngine "authn-server/internal/app/http"
...
func main() {
	...
	configs.Logger.Info("Server started successfully",
		zap.String("httpPort", configs.Configs.Service.HttpPort),
		zap.String("grpcPort", configs.Configs.Service.GrpcPort),
	)
