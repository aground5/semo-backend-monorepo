...
func (s *EmailService) SendEmail(from, to, subject, htmlBody string) error {
	...
	d := gomail.NewDialer(configs.Configs.Email.SMTPHost, configs.Configs.Email.SMTPPort, configs.Configs.Email.Username, configs.Configs.Email.Password)
